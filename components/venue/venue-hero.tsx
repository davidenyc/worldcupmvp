      ...
      <div className="relative grid gap-6 lg:grid-cols-[1.15fr,0.85fr]">
          ...
          <div className="flex items-center justify-between gap-4 pb-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-line bg-white px-4 py-2 text-sm font-semibold text-navy transition hover:bg-sky/50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
        ...
        <div className="space-y-4">
          ...
          <div className="surface p-5">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="rounded-2xl bg-white p-4 dark:bg-white/5">
                <div className="text-xs text-mist dark:text-white/55">Approx. capacity</div>
                <div className="mt-2 text-3xl font-semibold text-deep dark:text-white">{venue.approximateCapacity ?? "--"}</div>
              </div>
              <div className="rounded-2xl bg-white p-4 dark:bg-white/5">
                <div className="text-xs text-mist dark:text-white/55">Reservation status</div>
                <div className="mt-2 text-xl font-semibold text-deep dark:text-white">
          ...
          <div className="surface p-5">
            ...
            <div className="mt-2 text-2xl font-semibold text-deep dark:text-white">{soccerAtmosphere} soccer atmosphere</div>
